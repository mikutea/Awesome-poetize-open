...
export async function loadFonts(sysConfig) {
  ...
  // Unicode范围变量，初始使用内置的Unicode范围
  let baseRange = baseFontRange;
  let level1Range = level1FontRange;
  let level2Range = level2FontRange;
  let otherRange = otherFontRange;
